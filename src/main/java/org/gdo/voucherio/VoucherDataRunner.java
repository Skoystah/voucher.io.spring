...
public class VoucherDataRunner implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        this.voucherRepository.save(new Voucher("LEU123", VoucherDuration.ONE_HOUR, true));
        this.voucherRepository.save(new Voucher("LEU456", VoucherDuration.TWELVE_HOURS, false));
        this.voucherRepository.save(new Voucher("LEU789", VoucherDuration.TWO_HOURS, true));
        this.voucherRepository.save(new Voucher("LEU135", VoucherDuration.FOUR_HOURS, false));
    }
